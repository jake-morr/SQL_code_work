select distinct StC.person_uid person
    , StC.academic_period
...
where StC.academic_period between '201140' and '202020' 
and AcSt.student_level in ('US','UG')
and AO.award_category = '24'
group by StC.person_uid, StC.academic_period, AcSt.major_desc, AcSt.COLLEGE_DESC
order by person_uid
